 ...
 * to various Data Transfer Objects (DTOs) used in the health document linking process.
 *
...
public class Mapper {
     ...
     */
    public static AppointmentDTO mapToAppointmentDTO(HealthDocumentLinkingDTO data) {
        return mapper.mapToAppointmentDTO(data);
    }
     ...
     */
    public ConsultationDTO mapToConsultationDTO(HealthDocumentLinkingDTO data,
                                                String appointmentReference,
