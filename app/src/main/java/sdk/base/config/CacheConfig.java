 ...
 * {@link CacheManager} bean that manages caches for different entities such as facilities,
 ...
 * <ul>
 *   <li><strong>Cache Names:</strong> "facilityCache", "practitionerCache", "patientCache"</li>
...
public class CacheConfig {
    ...
    public CacheManager cacheManager() {
        CaffeineCacheManager cacheManager = new CaffeineCacheManager("facilityCache", "practitionerCache", "patientCache");
