 ...
 * used in health document linking workflows, such as {@link AppointmentDTO}, {@link CreateCareContextDTO},
 * {@link ConsultationDTO}, and {@link LinkCareContextDTO}.
 *
 ...
 * <h3>Key Features:</h3>
 * <ul>
 *   <li><strong>DTO Mappings:</strong> Maps health document linking data to appointment, care context, consultation, and link care context DTOs.</li>
...
public interface HealthDocumentMapper {
    ...
    /**
     * Maps {@link HealthDocumentLinkingDTO} to {@link AppointmentDTO}.
     *
     * @param data {@link HealthDocumentLinkingDTO} source object
     * @return {@link AppointmentDTO} with mapped values
     */
    @Mapping(target = "start", source = "appointmentStartDate")
    @Mapping(target = "end", source = "appointmentEndDate")
    @Mapping(target = "slot", source = "appointmentSlot")
    AppointmentDTO mapToAppointmentDTO(HealthDocumentLinkingDTO data);
    ...
    /**
     * Maps {@link HealthDocumentLinkingDTO} to {@link ConsultationDTO}.
     *
     ...
     * @return {@link ConsultationDTO} with mapped values
     */
    ...
    ConsultationDTO mapToConsultationDTO(HealthDocumentLinkingDTO data,
                                         String appointmentReference,
    ...
    @Mapping(target = "authMode", constant = "DEMOGRAPHICS")
